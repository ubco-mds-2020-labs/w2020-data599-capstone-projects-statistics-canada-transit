...
addCircles(~longitude, ~latitude, weight = 1, radius=5,
...
color="#0073B2", stroke = TRUE, fillOpacity = 0.8)->map
  }
...
```{r}
map_maker_scores(scores_viz_frame_st, amenity="museum",weight="yes",nearest_n="all",view_map = T,add_stop=F)
```
