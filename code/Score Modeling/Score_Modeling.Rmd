...
# naive_score(fromIds, mean_time, mean_sd_time, n_accessible, x=0.01, y=0.99, log = FALSE)
...
# simple_sum_score_fxn(df, weight = FALSE, log_normalize_score = TRUE, normalize_df = FALSE, x=0.01, y=0.99)
```
