...
all_data %>%
  ...
  theme(aspect.ratio = 0.6,
        ...
        axis.text.y = element_blank(),
        axis.ticks.y = element_blank()) 
ggsave('Uniform Score Distribution.png', width = 8, height = 6)
...
ggsave('Overall Time Distribution to Nearest Amenity.png', width = 8, height = 6)
...
ggsave('Overall Time Distribution to Any Amenity.png', width = 8, height = 6)
...
ggsave('Violin log(Score) Distributions.png', width = 8, height = 8)
...
all_data_small %>%
  ...
  geom_violin(aes(fill = subdiv), scale = 'width', alpha = 0.4, draw_quantiles = c(0.5), size = 0.5) + 
  scale_fill_discrete(breaks=legend_ord) +
  scale_x_continuous("Average Accessibility Score",
...
all_data_small %>%
  ggplot(aes(y =reorder(factor(subdiv), -time_to_nearest_amenity, na.rm = TRUE),
             x = (time_to_nearest_amenity))) +
  geom_violin(aes(fill = subdiv), scale = 'width', alpha = 0.4, draw_quantiles = c(0.5), size = 0.5) + 
  scale_fill_discrete(breaks=legend_ord) +
...
ggsave('Violin Time Distributions.png', width = 8, height = 8)
...
ggsave('Time to nearest amenity distributions.png', width = 8, height = 8)
...
ggsave('Overlaid time to nearest amenity distributions.png', width = 8, height = 8)
...
all_data_small %>%
  ggplot(aes(y =reorder(factor(subdiv), -avg_time_to_any_amenity, na.rm = TRUE),
             x = (avg_time_to_any_amenity))) +
  geom_violin(aes(fill = subdiv), scale = 'width', alpha = 0.4, draw_quantiles = c(0.5), size = 0.5) + 
  scale_fill_discrete(breaks=legend_ord) +
  scale_x_continuous("Average Time in Minutes") +
                     #limits = c(0, 0.3), breaks=c(0,0.1,0.2,0.3)) +
...
ggsave('Violin Time Distribution to All Amenities.png', width = 8, height = 8)
...
ggsave('Time to all amenity distributions.png', width = 8, height = 8)
