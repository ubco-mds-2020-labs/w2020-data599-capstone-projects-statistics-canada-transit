...
```{R}
merged_data%>%select(poi_name,Name,open_days,Total_hours,Rating,Total_Review)->df

colnames(df)
colnames(df) <- c("POI Name", "Google Place Name","Open Days","Open Hours","Rating","Total Review")
df[df == 0] <- NA
