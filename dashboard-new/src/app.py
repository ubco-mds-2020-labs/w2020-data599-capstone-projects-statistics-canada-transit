...
first_card = dbc.Card(
    dbc.CardBody(
        children=[html.P("Career FG%", className="card-title"), html.H5(id="card-01")]
    ),
    color="info",
    inverse=True,
...
second_card = dbc.Card(
    dbc.CardBody(
        children=[html.P("Career FT%", className="card-title"), html.H5(id="card-02")]
    ),
    color="secondary",
    inverse=True,
    style={"text-align": "center"},
...
dropdowns = dbc.Row(
    [
        dbc.Col(first_dropdown),
        dbc.Col(second_dropdown),
        dbc.Col(html.H5("")),
    ]
)
...
fifth_dropdown = html.Div(
    [
        dcc.Dropdown(
            ...
            options=[{"label": stat, "value": stat} for stat in longform_stat_list],
        )
    ],
    style={"width": "100%"},
)
...
dropdowns2_3 = dbc.Row(
    [
        dbc.Col(fifth_dropdown),
        dbc.Col(html.H5("")),
    ]
)


dropdowns3 = dbc.Row([dbc.Col(sith_dropdown), dbc.Col(html.H5(""))])
